// Application layer types - these will use Bipins.AI types when the NuGet package is available
// For now, keep local types that match Bipins.AI structure

namespace Bipins.AI.Trading.Application.LLM;

// These types match Bipins.AI.LLM types and will be replaced with using Bipins.AI.LLM when package is available
